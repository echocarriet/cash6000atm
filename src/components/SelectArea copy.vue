...
export default {
  ...
  methods: {
    ...
    get6000Atm() {
      ...
      const api = 'https://raw.githubusercontent.com/echocarriet/get6000atm_test/main/public/js/6000Atm.json';
      this.$http
        .get(api)
        .then((res) => {
    ...
    render6000Atm() {
      console.log(this.$refs.selectTown.value);
      console.log(this.cityNameTw);
